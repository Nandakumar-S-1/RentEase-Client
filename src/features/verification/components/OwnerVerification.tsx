...
import { Upload, FileCheck, Clock, AlertCircle, CheckCircle } from "lucide-react";
...
const OwnerVerification = () => {
    ...
    const { submit, fetchStatus, isLoading, error, successMessage, status } = useSubmitVerification();
    const fileInputRef = useRef<HTMLInputElement | null>(null);

    const [documentType, setDocumentType] = useState<"PAN" | "AADHAAR">("AADHAAR");
        ...
        return (
            <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
                <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg text-center">
                    ...
                    <h1 className="mb-2 text-2xl font-bold text-gray-900">Verification Under Review</h1>
            ...
            <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        ...
                        <select
                            value={documentType}
                            onChange={(e) => setDocumentType(e.target.value as "PAN" | "AADHAAR")}

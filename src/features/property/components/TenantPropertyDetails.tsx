          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div className="space-y-4">
              <div className="flex flex-wrap gap-2">
                <span className="px-4 py-1 bg-primary/10 text-primary text-[10px] font-black uppercase tracking-widest rounded-lg">
                  Verified Listing
                </span>
                <span className="px-4 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-black uppercase tracking-widest rounded-lg">
                  {property.propertyType}
                </span>
                {property.furnishingStatus && (
                  <span className="px-4 py-1 bg-blue-50 text-blue-600 text-[10px] font-black uppercase tracking-widest rounded-lg">
                    {property.furnishingStatus}
                  </span>
                )}
              </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-500 leading-[2] text-lg font-medium">
            ...
            <div className="sticky top-6 space-y-8">
              <div className="bg-white dark:bg-card border border-gray-100 rounded-[3rem] p-10 shadow-2xl shadow-primary/5">
                <div className="mb-10 text-center">
                  ...
                  <div className="flex items-center justify-center gap-1">
                    ...
                    <span className="text-gray-400 font-bold self-end pb-1">
                      /mo
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 dark:bg-white/5 rounded-[2.5rem] p-8 space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h5 className="font-black text-lg text-gray-900 dark:text-white">
                      Verified Owner
                    </h5>

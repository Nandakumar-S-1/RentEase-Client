        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <p className="text-gray-400 font-medium tracking-tight">
              Management portal for {property.title}
            </p>
          </div>
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/90 text-sm font-medium leading-relaxed">
                        {property.rejectionReason ||
                          "No specific reason provided by the auditor."}
                      </p>
                      <button
                        onClick={handleEdit}
              ...
              <div className="absolute bottom-10 left-10 text-white">
                <div
                  className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest mb-4 ${status.bg} ${status.color}`}
                >
                  <status.icon size={14} />
                  {status.label}
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                {
                  label: "Floor Detail",
                  val: property.floorNumber || "N/A",
                  icon: Layers,
                  color: "bg-violet-500",
                },
                {
                  label: "Monthly Rent",
                  val: `₹${property.monthlyRent?.toLocaleString() || 0}`,
                  icon: TrendingUp,
                  color: "bg-primary",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="bg-white dark:bg-card border border-gray-100 dark:border-white/5 rounded-[2rem] p-6 shadow-sm hover:translate-y-[-4px] transition-all"
                >
                  <div
                    className={`w-10 h-10 ${item.color}/10 rounded-xl flex items-center justify-center mb-4`}
                  >
                    <item.icon
                      size={20}
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                  {property.amenities.map((amenity: string) => (
                    <div
                      key={amenity}
                      className="flex items-center gap-3 p-5 bg-white dark:bg-card border border-gray-100 rounded-3xl group hover:border-primary/30 transition-all"
                    >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gray-50/50 dark:bg-white/5 rounded-2xl border border-gray-100">
                    ...
                    <span
                      className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest ${property.petsAllowed ? "bg-emerald-50 text-emerald-600" : "bg-red-50 text-red-600"}`}
                    >
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50/50 dark:bg-white/5 rounded-2xl border border-gray-100">
                    ...
                    <span
                      className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest ${property.smokingAllowed ? "bg-emerald-50 text-emerald-600" : "bg-red-50 text-red-600"}`}
                    >
                  ...
                  {property.maximumOccupants && (
                    <div className="flex items-center justify-between p-4 bg-gray-50/50 dark:bg-white/5 rounded-2xl border border-gray-100">
                      ...
                      <span className="font-black text-gray-900 dark:text-white">
                        {property.maximumOccupants} Persons
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div className="bg-white dark:bg-card border border-gray-100 dark:border-white/5 rounded-[3rem] p-10 shadow-sm space-y-8 sticky top-10">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-5 p-6 bg-gray-50 dark:bg-white/5 rounded-3xl group cursor-help transition-all hover:bg-primary/5">
                  ...
                  <div>
                    <p className="text-sm font-black text-gray-400 uppercase tracking-tight leading-none mb-1">
                      Total Impact
                    </p>
              ...
              <div className="p-6 bg-primary/5 rounded-[2rem] border border-primary/10">
                ...
                <p className="text-xs text-primary/70 font-medium leading-relaxed italic">
                  Properties with clear, well-lit photos get 3x more inquiries.
                  Keep your media high-resolution!
                </p>
              </div>

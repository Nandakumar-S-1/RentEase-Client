    ...
    >
      <div className="max-w-7xl mx-auto space-y-8 pb-20 animate-in fade-in duration-700">
        ...
        {!wishlistItems || wishlistItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-32 bg-[color:var(--color-surface)] dark:bg-white/5 rounded-xl border-2 border-dashed border-[color:var(--color-border)] shadow-inner">
            <div className="w-24 h-24 bg-[color:var(--color-card)] rounded-xl shadow-xl flex items-center justify-center mb-8 text-gray-300 border border-[color:var(--color-border)]">
            ...
            <button
              ...
              className="flex items-center gap-3 px-10 py-4 bg-primary text-white font-black rounded-lg shadow-2xl shadow-primary/30 hover:scale-105 active:scale-95 transition-all"
            >
              <Search size={20} />
              Start Browsing
            </button>

    ...
    >
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-black text-[color:var(--color-foreground)]">
              {isSearchMode ? "Find Properties" : "My Properties"}
            </h1>
            <p className="text-gray-500">
              {isSearchMode
                ? "Discover your next home in Kerala"
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-red-50/20 dark:bg-red-500/5 rounded-3xl border border-red-100 dark:border-red-500/10">
            ...
            <button
              ...
              className="px-6 py-2 bg-red-500 text-white rounded-xl shadow-lg shadow-red-500/20"
            >
              Retry
            </button>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-24 bg-gray-50/50 dark:bg-white/5 rounded-3xl border border-dashed border-[color:var(--color-border)]">
            ...
            <h3 className="text-xl font-bold text-[color:var(--color-foreground)] mb-2">
              No properties found
            </h3>

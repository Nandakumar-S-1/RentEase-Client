...
const AdminOwnerVerification = () => {
    const { owners, isLoading, error, successMessage, fetchPendingOwners, approve, reject } =
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 mb-1">Owner Verification</h1>
                    <p className="text-gray-500">Review and verify owner identity documents.</p>
                </div>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-gray-400">ID: {owner.id.slice(-6).toUpperCase()}</p>
                                                </div>
                                            </div>
                                        </td>
